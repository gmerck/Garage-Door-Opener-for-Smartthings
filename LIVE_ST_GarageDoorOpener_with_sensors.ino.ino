...
#define PIN_CONTACT_2             D7  //SmartThings Capabilty Button / Holdable Button (Normally Open!)
...
//******************************************************************************************
String str_ssid     = "trillian";                           //  <---You must edit this line!
String str_password = "rytykiwi";                   //  <---You must edit this line!
IPAddress ip(192, 168, 105, 131);       //Device IP Address       //  <---You must edit this line!
IPAddress gateway(192, 168, 105, 1);    //Router gateway          //  <---You must edit this line!
IPAddress subnet(255, 255, 255, 0);   //LAN subnet mask         //  <---You must edit this line!
IPAddress dnsserver(192, 168, 105, 1);  //DNS server              //  <---You must edit this line!
const unsigned int serverPort = 8090; // port to run the http server on

// Smartthings / Hubitat Hub TCP/IP Address
IPAddress hubIp(192, 168, 105, 100);    // smartthings/hubitat hub ip //  <---You must edit this line!
...
void setup()
{
  ...
  static st::S_TimedRelay           sensor8(F("relaySwitch1"), PIN_TIMEDRELAY_1, LOW, true, 1000, 0, 1);
